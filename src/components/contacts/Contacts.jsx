...
const Contacts = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_gcpldni', 'template_9te3py9', form.current, {publicKey: 'umO0sUUBpE_NFFHXI'})
          .then(
            () => {
                setSuccess(true)
                setError(null)
    ...
    <motion.div className='contact' variants={variants} initial='initial' whileInView="animate" ref={ref}>
        <motion.div  variants={variants} className="textContainer">
            ...
            <motion.div  variants={variants} className="item">
                <h2>Mail</h2>
                <span>sanjaypandian01@gmail.com</span>
            </motion.div>
            <motion.div  variants={variants} className="item">
                <h2>Address</h2>
        ...
        <div className="formContainer">
            ...
            <motion.form ref={form} initial={{opacity:0}} whileInView={{opacity:1}} transition={{ delay:4, duration:1}} onSubmit={sendEmail}>
